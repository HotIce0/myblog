                        ...
                        <ul>
                            ...
                            @foreach($data[$i] as $item)
                                <li>
                                    ...
                                    <span class="am-u-sm-5 am-u-md-5">@if($item['is_publish'] == 0)<span class="am-badge am-badge-warning">未发布</span>&nbsp;&nbsp;@endif<a href="{{route('article', 'id='.($item['archive_id']))}}">{{$item['titile']}}</a></span>
